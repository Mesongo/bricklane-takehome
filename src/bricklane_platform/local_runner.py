...
def main(csv_path, source, share_price):
    ...
    share_orders = share_engine.generate_share_orders(
        share_price, eligible_payments)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "source", help="The source of the payment, currently only 'card' is supported")
    parser.add_argument("share_price", type=Decimal,
